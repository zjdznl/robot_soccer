...
class Controller():
    ...
    ###        
        ...
        while(atBall == False):
            ...
            # time.sleep(1)
            # print "STOP1!!!"
            # self.motion.setWalkTargetVelocity(1.0, 0.0, angleRounded, 0)
            # time.sleep(1)
            # print "STOP2!!!"
            # self.motion.setWalkTargetVelocity(1.0, 0.0, angleRounded, speed)
    ...
    ###      
        ...
        if(landMarkAngle!=10):
            ...
            self.motion.moveTo(x-0.08,y-0.05, 0)
            # Nao kicks the ball
            self.motion.kickBall()
