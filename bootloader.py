...
class Bootloader(ALModule):
    ...
    def __init__(self, name):
        ...
        memory.subscribeToEvent("FrontTactilTouched", "bootloadr", "onTouched")
    ...
    def onTouched(self, *_args):
        ...
        memory.unsubscribeToEvent("FrontTactilTouched", "bootloadr")
        # Nao says Start Scoccer
        self.tts.say("Start soccer")
        # subscribe to these events
        memory.subscribeToEvent("FrontTactilTouched", "bootloadr", "onSecondTouch")
        # start main function
        main.start()
